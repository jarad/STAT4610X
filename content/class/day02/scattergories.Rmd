...
scattergories_letters
```

Randomly choose letters:

```{r random-letters}
random_letters <- sample(scattergories_letters, 6, replace = FALSE)
```
...
Letter: 
```{r individual-free-for-all-sport-letter}
random_letters[5]
```
...
Letter: 
```{r team-free-for-all-sport-letter}
random_letters[6]
```
